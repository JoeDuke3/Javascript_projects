...
let activePlayer = 'X';
// This array strores an array of moves. 
// We use this to determine via conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        // This vaiable retrieves the html element id that was clicked.
    ...
    function computersTurn() {
        ...
        let success = false;
        // This variable stores a random numver 0-8.
        let pickASquare
...
// This function parses the selectedSquares to check for Win Conditions
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.beginPath();
        // This method moves us to a starting pooint for our line.
        c.moveTo(x1, y1);
