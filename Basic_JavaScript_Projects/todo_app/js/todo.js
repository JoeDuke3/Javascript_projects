...
function get_todos() {
    ...
    var todos = new Array;
    /* This pulls the task that was saved in the 
    web browser memory*/
    var todos_str = localStorage.getItem('todo');
    /* If the Input is not null then JSON.parse will 
    communicate with the web browser to make the task
    a JavaScript object*/
    if (todos_str !== null) {
...
/* This function adds the inputed task to the 
get todos function array*/
function add() {
...
function show() {
    ...
    /* This sets up such task as an unordered list*/
    var html = '<ul>';
